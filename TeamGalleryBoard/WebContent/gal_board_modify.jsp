					...
					<div class="container" id="formInnerWrapper">
						<form action="galModifyPro.bo" method="post" name="modifyform">
							...
							<div class="form-group">
								...
								<div class="col-xs-8">
									<label class="labels active"
										style="font-size: 16px; letter-spacing: normal;">글쓴이</label> <input
										type="text" class="formInput" id="GB_ID" name="GB_ID"
										style="letter-spacing: normal; font-size: 14px;">
								</div>
							...
							<div class="form-group formtotalsize">
								...
								<div class="col-xs-8">
									...
									<textarea name="GB_CONTENTS" id="GB_CONTENTS"
										class="contentbox"><%=article.getGB_CONTENTS()%></textarea>
								</div>
