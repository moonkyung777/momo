						...
						<div class="wrap-table100">
							<div class="table" align="center">
								...
								<div class="row header">
									<div class="cell">경기날짜/시간</div>
									<div class="cell">팀이름1</div>
									<div class="cell">결과</div>
									<div class="cell">팀이름2</div>
									<div class="cell">경기정보</div>
								</div>

								<div class="row">
									<div class="cell" data-title="경기날짜/시간">
										2019.10.05(토) 20:00<br> AIA Vitality Arena (A구장)
									</div>
									<div class="cell" data-title="팀이름1">
										FC BTC7
										<div class="teamlogo">
											<img src="img/teamlogo1.png">
										</div>
									</div>
									<div class="cell" data-title="결과">0 : 3</div>
									<div class="cell" data-title="팀이름2">
										FC BTC7
										<div class="teamlogo">
											<img src="img/teamlogo2.png">
										</div>
									</div>
									<div class="cell" data-title="경기정보">
										<div class="pressDown" onClick="schedulebutton()">
											경기정보</a>
										</div>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="cell" data-title="경기정보">
										<div class="pressDown">
											<a href="leagueschedule.html" style="color: white">경기정보</a>
										</div>
									</div>
								</div>
