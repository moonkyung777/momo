...
<body>
	...
	<div id="mainleft"style="height: 1200px;">
	...
	<section id="main">
		...
		<section id="mainright" style="height: 85%;">
			<div id="matList" >

				<div class="container" id="formOutterWrapper">
					<center>
						<div class="writeboardtitle"
							style="text-align: center; font-size: 50px;">지점 등록</div>
					...
					<div class="container" id="formInnerWrapper">
						<form name="yongjoin" id="materialForm" class="form" method="post"
							...
							<div class="form-group">
								...
								<div class="col-xs-8">
								<label class="labels" for="BRANCH_NAME">지 점 명 </label> <input
										type="text" class="formInput" id="BRANCH_NAME" name="BRANCH_NAME"
							...
							<div class="form-group">
								<div class="col-xs-2"></div>
								<div class="col-xs-4">
									<label class="labels" for="y_b_name">신청자명</label> <input
										type="text" class="formInput" id="y_b_name" name="y_b_name"
										style="font-size: 18px;">
								</div>
								<div class="col-xs-1">
								...
								<div class="col-xs-1">
									<select class="formInput" id="BRANCH_TEL_1" name="BRANCH_TEL_1">
								...
								<div class="col-xs-1">
									<label class="labels" for="BRANCH_TEL_2"></label> <input
										type="text" class="formInput" id="BRANCH_TEL_2" name="BRANCH_TEL_2"
										style="font-size: 18px;">
								</div>
								<div style="float: left;">-</div>
								<div class="col-xs-1">
									<label class="labels" for="y_b_tel3"></label> <input
										type="text" class="formInput" id="y_b_tel3" name="y_b_tel3"
										style="font-size: 18px;">
								</div>
							</div>
							<div class="form-group">
								<div class="col-xs-2"></div>
								<div class="col-xs-8">
									<label class="labels" for="sin1">사업자 등록번호</label> <input
										type="text" class="formInput" id="sin1" name="sin1"
										style="font-size: 18px;">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<label class="labels">편의시설</label>
								</div>
								<div class="col-xs-7 checkbox">
								<div id="checkboxmargin" name ="BRANCH_CONVENIENCE">

									<div class="col-xs-2">
										<label2> <input type="checkbox" name=hobby value="aa">주차장 </label2>
									</div>
										<div class="col-xs-2">
										<label2> <input type="checkbox" name=hobby value="bb">냉방시설 </label2>
									</div>
											<div class="col-xs-2">
										<label2> <input type="checkbox" name=hobby value="cc">샤워실 </label2>
									</div>
										<div class="col-xs-2">
										<label2> <input type="checkbox" name=hobby value="dd">공대여 </label2>
									</div>
									<div class="col-xs-2">
										<label2> <input type="checkbox" name=hobby value="ee">조끼대여 </label2>
									</div>
									<div class="col-xs-2">
										<label2> <input type="checkbox" name=hobby value="ff">풋살화대여 </label2>
									</div>
									</div>
								</div>
							</div>
								...
								<div class="col-xs-4">
									...
									<textarea name="y_b_contents" id="y_b_contents"
