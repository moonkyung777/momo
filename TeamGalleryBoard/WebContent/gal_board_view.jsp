				...
				<div class="container" id="formOutterWrapper">
					<center>
						...
						<div class="container" id="formInnerWrapper">
							...
							<table>
								<tr>
									<td class="viewsubject">제목</td>
									<td class="viewform"><%=article.getGB_SUBJECT()%></td>
								</tr>
								<tr>
									<td class="viewsubject">글쓴이</td>
									<td class="viewform"><%=article.getGB_ID()%></td>
								</tr>
								<tr>
									<td class="viewsubject">첨부파일</td>
									<td class="viewform">
										<%
											if (!(article.getGB_FILE() == null)) {
										%> <a href="gal_file_down.jsp?downFile=<%=article.getGB_FILE()%>"> <%=article.getGB_FILE()%>
									</a> <%
 	}
 %>
									</td>
								...
								<tr>
									<td class="viewsubject">내용</td>
									</td>
									<td class="viewform" style="height: 400px;"><img src="boardUpload/<%=article.getGB_FILE()%>" style="width: 290px; height: 270px;">
									<br><br><%=article.getGB_CONTENTS()%></td>
								</tr>
							</table>
<section id="commandList">
								<a href="galReplyForm.bo?GB_NUM=<%=article.getGB_NUM()%>&page=<%=nowPage%>"> [답변] </a>
								
								<% if(uss.equals(article.getGB_ID())){%>
								<a href="galModifyForm.bo?GB_NUM=<%=article.getGB_NUM()%>"> [수정] </a>
								<a href="galDeleteForm.bo?GB_NUM=<%=article.getGB_NUM()%>&page=<%=nowPage%>"> [삭제] </a>
								<%} %>
