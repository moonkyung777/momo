			...
			<div id="matList">
				...
				<div class="container" id="formOutterWrapper">
					...
					<div class="container" id="formInnerWrapper">
						<form name="yongjoin" id="materialForm" class="form" method="post" action="galWritePro.bo" role="form" autocomplete="off" enctype="multipart/form-data">
							...
							<div class="form-group">
								<div class="col-xs-2"></div>
								<div class="col-xs-4">
									 <input type="file" class="formInput" id="GB_FILE" name="GB_FILE" style="font-size:18px;">
								</div>
							</div>
							...
							<div class="form-group" style="height:284px;">
								...
								<div class="col-xs-4">
									...
									<textarea name=GB_CONTENTS id="GB_CONTENTS" style="width:730px;resize:none; height:200px;" placeholder="메모를 입력하세요." ></textarea>
								</div>
								
							</div>
							
							
							<input type ="hidden" id="GB_ID" name ="GB_ID" value="<%=logid%>"/>
							<div class="form-group" style="">
								<div class="col-xs-4" style="font-size: 14px;"></div>

								<div class="col-xs-4" style="margin-left: 45px;">
									
									<input type="button" value="등록" class="signbutton signbutton5" onClick="document.yongjoin.submit()" style="font-size:18px; width:140px; letter-spacing:5px;">
