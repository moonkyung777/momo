					...
					<div class="container" id="formInnerWrapper">
						<form action="galReplyPro.bo" method="post" name="boardform">
							...
							<div class="form-group" style="height: 550px;">
								<div class="col-xs-2"></div>
								<div class="col-xs-8">
									<label class="labels" for="GB_CONTENTS"></label>
									<textarea name="GB_CONTENTS" id="GB_CONTENTS" style="width: 730px; resize: none; height: 470px;" placeholder="내용을 입력하세요."></textarea>
								</div>
