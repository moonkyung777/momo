...
<script type="text/javascript">
	...
	function boardformsubmit()
	{
		...
		var boardformlen=boardform.GB_FILE.value.length
		
		if(boardformlen<=0)
		{
			alert("이미지를 추가해주세요.");
			boardform.boardformlen.focus();
		}else
		{
...
%>
	...
	<div id="mainleft" style="height: 1000px;">
	...
	<section id="main" >
		...
		<section id="mainright" >
			<div id="matList" >
				...
				<div class="container margin4 fontsize" id="formOutterWrapper" >
					<center>
						<div class="writeboardtitle">게시글 작성</div>
					</center>
					<div class="container" id="formInnerWrapper" style="height:100% ">
						...
						<form action="galWritePro.bo" method="post" enctype="multipart/form-data" name="boardform" role="form">
							...
							<div class="form-group">
								...
								<div class="col-xs-4 buttonmargin">
									...
									<input type="button" value="등록" class="signbutton signbutton5 buttongal" style="font-size: 15px;"onClick="boardformsubmit()"> <input type="button" value="취소" class="signbutton signbuttoncancel buttongal margin3" style="font-size: 15px; " onClick="script: location.href='gal_board_list.jsp'">
								</div>
							</div>
