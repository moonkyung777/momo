...
<body>
	...
	<form action="QnaInsert.jsp" id="frm">
		<div id="mainleft">
			<div id="leftbanner">
				<div id="banner1">
		...
		<section id="main">
			<section id="mainright">
				<div id="matList">
					<div class="sec_ban2">
						<ul class="nav_ban">
							<li><img src="img/qna.jpg"
								style="width: 100%; height: 200px"></li>
						</ul>
					</div>
					<div class="cbox">
						<table class="table table-striped">
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="form-group has-success">
											<input type="text" class="form-control" id="qnaid"
												name="qnaid" maxlength="10" style="width: 250px">
										</div>
									</td>
								</tr>
								<tr>
									...
									<td>
										<div class="form-group has-warning" style="height: 45px">
											<input type="text" class="form-control" id="qnapw"
												name="qnapw" maxlength="10" style="width: 250px"> <label
												class="control-label" for="inputWarning1"> 글 수정,
												삭제,비밀글 확인시 사용됩니다. </label>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td>
										<div class="has-warning">
											<div class="checkbox">
												<label> <input type="checkbox" id="secret"
													name="secret"> 비밀글 설정시 체크박스에 표시
												</label>
											</div>
										</div>
									</td>
								...
								<tr>
									<td>내용</td>
									<td><textarea class="form-control" rows="7" id="qContents"
											name="qContents">
										</textarea></td>
								</tr>
							</tbody>
						...
						<a class="btn btn-default" style="float: right; margin-left: 5px;" >
							목록 </a> 
<input type=submit class="btn btn-default pull-right" id="write" name="write" value="글쓰기"> <br> <br> <br>
						<br> <br> <br>
						<table class="table table-striped">
							<thead>
								<tr id="tabletitle">
							...
							<tbody>
								...
								<tr>
									<td class="thgongji">
										<%
										out.println(qda.get(i).getqNo());
										%></a><img src="img/lock2.png" class="secretimg">
									</td>
									<td class="thtitle">
										<a href><%
									...
									<td class="thdate">
										...
										out.println(qda.get(i).getqCount());
										%>
									</td>
									<td class="thview">
										<%
							...
							<input class="btn btn-default" type="button" value="검 색"
