 ...
 * Generated at: 2020-01-10 08:02:19 UTC
...
import qnaPack.QnaDao;
import qnaPack.QnaDto;
import java.sql.*;
...
public final class qna_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("qnaPack.QnaDto");
    _jspx_imports_classes.add("qnaPack.QnaDao");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	//수정부분 끝
      ...
      out.write("\r\n");
      out.write("\r\n");
      qnaPack.QnaDao qdtt = null;
      qdtt = (qnaPack.QnaDao) _jspx_page_context.getAttribute("qdtt", javax.servlet.jsp.PageContext.PAGE_SCOPE);
      if (qdtt == null){
        qdtt = new qnaPack.QnaDao();
        _jspx_page_context.setAttribute("qdtt", qdtt, javax.servlet.jsp.PageContext.PAGE_SCOPE);
      }
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t</header>\r\n");
      out.write("\t<form action=\"QnaInsert.jsp\" id=\"frm\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<li><img src=\"img/qna.jpg\"\r\n");
      out.write("\t\t\t\t\t\t\t\tstyle=\"width: 100%; height: 200px\"></li>\r\n");
      out.write("\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"qTitle\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"qTitle\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group has-success\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"qnaid\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"qnaid\" maxlength=\"10\" style=\"width: 250px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group has-warning\" style=\"height: 45px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"qnapw\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tname=\"qnapw\" maxlength=\"10\" style=\"width: 250px\"> <label\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"control-label\" for=\"inputWarning1\"> 글 수정,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t삭제,비밀글 확인시 사용됩니다. </label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>비밀글 설정</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"has-warning\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"checkbox\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label> <input type=\"checkbox\" id=\"secret\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"secret\"> 비밀글 설정시 체크박스에 표시\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>내용</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><textarea class=\"form-control\" rows=\"7\" id=\"qContents\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tname=\"qContents\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</textarea></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t<a class=\"btn btn-default\" style=\"float: right; margin-left: 5px;\" >\r\n");
      out.write("\t\t\t\t\t\t\t목록 </a> \r\n");
      out.write("<input type=submit class=\"btn btn-default pull-right\" id=\"write\" name=\"write\" value=\"글쓰기\"> <br> <br> <br>\r\n");
      out.write("\t\t\t\t\t\t<br> <br> <br>\r\n");
      out.write("\t\t\t\t\t\t<table class=\"table table-striped\">\r\n");
      out.write("\t\t\t\t\t\t\t<thead>\r\n");
      ...
      out.write("</a><img src=\"img/lock2.png\" class=\"secretimg\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tstyle=\"width: 200px; float: left; margin-left: 150px;\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tstyle=\"width: 300px; float: left; margin-left: 10px;\">\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"btn btn-default\" type=\"button\" value=\"검 색\"\r\n");
